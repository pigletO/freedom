package com.pig1et.freedom.ordermobile.util;
...
public class CodeGenerator {
	 ...
	 */
	private static final String PACKAGE_NAME = "com.pig1et.admin.springbootmybatisplus";
...
//		System.out.println("代码已全部生成完毕！");
	...
	private static PackageConfig getPackageConfig(String tableNames) {
		...
		packageConfig.setParent(PACKAGE_NAME + "." + tableNamez.toLowerCase())
				.setEntity("entity")
				.setMapper("com/pig1et/admin/mapper")
				.setServiceImpl("com/pig1et/admin/service")
				.setController("com/pig1et/admin/controller");
